...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_tb_traffic_light_controller_behavior(const char*);
        topvh = createWork_tb_traffic_light_controller_behavior("tb_traffic_light_controller");
